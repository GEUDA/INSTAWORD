...
exports.sendRegistrationUrl = function(email_address, token) {
  var option = {
    ...
    to: email_address,
    subject: 'Instaword: USER REGISTRATION',
    html: '<h1>REGISTRATION URL</h1>'
      ...
      + '<p><a href="http://pickmemo.net/instaword/sessions/register/' + token + '">http://pickmemo.net/instaword/sessions/register/' + token + '</a></p>'
