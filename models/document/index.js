...
exports.get = function(data, callback) {
  ...
  DocumentModel.findOne(condition, field, {}, function(error, result) {
    if(error) {
      callback(error);
      return;
    }
...
/**
 * random
 * @param {Object<user_id, lanugage_list>} data
 * @param {Function} callback
...
exports.random = function(data, callback) {
  ...
  async.waterfall([
    // 行数を取得
    function(callback) {
      DocumentModel.count(function(error, result) {
        if(error) {
          callback(error);
          return;
        }
...
exports.remove = function(data, callback) {
  async.waterfall([
    function(callback) {
      ...
      DocumentModel.findOneAndRemove(condition, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
