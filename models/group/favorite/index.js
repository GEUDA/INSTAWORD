...
var GroupFavoriteModel = models.GroupFavoriteModel
...
exports.list = function(data, callback) {
  ...
  async.waterfall([
    ...
    function(callback) {
      ...
      GroupFavoriteModel.find(condition, 'target_id', option, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
...
exports.get = function(data, callback) {
  ...
  async.waterfall([
    ...
    function(callback) {
      ...
      GroupFavoriteModel.count(condition, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
...
exports.set = function(data, callback) {
  var favorite = new GroupFavoriteModel({
    target_id: data._id,
    group_id: data.group_id,
    user_id: data.user_id
  });
...
exports.remove = function(data, callback) {
  ...
  GroupFavoriteModel.findOneAndRemove(condition, function(error) {
    if(error) {
      callback(error);
      return;
    }
