...
exports.list = function(req, res, next) {
  async.waterfall([
    function(callback) {
      ...
      models.group.favorite.list(data, function(error, result) {
        if(error) {
          return next(error);
        }
...
exports.set = function(req, res, next) {
  ...
  models.group.favorite.set(data, function(error, result) {
    if(error) {
      return next(error);
    }
    res.send('FAVORITED');
...
exports.remove = function(req, res, next) {
  ...
  models.group.favorite.remove(data, function(error, result) {
    if(error) {
      return next(error);
    }
