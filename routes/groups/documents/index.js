...
exports.timeline = function(req, res, next) {
  async.waterfall([
    function(callback) {
      ...
      models.group.document.timeline(data, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
    ...
    function(document_list, callback) {
      ...
      async.whilst(
        ...
        function(callback) {
          ...
          models.group.favorite.get(data, function(error, result) {
            if(error) {
              callback(error);
              return;
            }
...
exports.list = function(req, res, next) {
  async.waterfall([
    function(callback) {
      ...
      models.group.document.list(data, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
...
exports.random = function(req, res, next) {
  async.waterfall([
    function(callback) {
      ...
      models.group.document.random(data, function(error, result) {
        if(error) {
          callback(error);
          return;
        }
...
exports.post = function(req, res, next) {
  ...
  models.group.document.post(data, function(error, result) {
    if(error) {
      return next(error);
    }
    res.send('POSTED');
...
exports.edit = function(req, res, next) {
  ...
  models.group.document.edit(data, function(error, result) {
    if(error) {
      return next(error);
    }
    res.send('UPDATED');
